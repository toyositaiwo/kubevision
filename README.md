...
A production-ready Kubernetes dashboard with a built-in AI assistant powered by Google Gemini. Monitor your cluster health, pods, deployments, services, and more from a clean browser interface.
...
The AI assistant uses the Google Gemini API directly from the browser.
